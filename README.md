...
- Login with role-based access (admin and regular user roles)
...
- Global Kanban across all projects with drag-and-drop (mouse + touch), drop highlighting, success flash and toasts
